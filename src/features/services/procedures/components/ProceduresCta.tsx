...
import type { ProceduresCtaContent } from "@/domain/types/procedures.types";

type ProceduresCtaProps = {
  content: ProceduresCtaContent;
};

export const ProceduresCta = ({ content }: ProceduresCtaProps) => {
