...
import type { TransportCtaContent } from "@/domain/types/Transport";

type TransportCtaProps = {
  content: TransportCtaContent;
};

export const TransportCta = ({ content }: TransportCtaProps) => {
