...
import type { ConnectivityCtaContent } from "@/domain/types/Connectivity";

type ConnectivityCtaProps = {
  content: ConnectivityCtaContent;
};

export const ConnectivityCta = ({ content }: ConnectivityCtaProps) => {
