...
export default function PlansFinalCTA({ content }: PlansFinalCTAProps) {
  ...
  return (
    <section data-aos="fade-up" className="relative overflow-hidden rounded-3xl bg-primary px-6 py-14 text-white shadow-lg sm:px-10 md:px-16">
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <h2 data-aos="fade-up" data-aos-delay={80} className="text-4xl font-extrabold leading-tight md:text-6xl">
          {content.titleLineOne}
          <br />
          {content.titleLineTwo}
        </h2>
        <p data-aos="fade-up" data-aos-delay={140} className="mt-4 text-base leading-7 text-sky-100 md:text-xl">{content.description}</p>
