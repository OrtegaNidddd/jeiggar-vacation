...
export const ProceduresProcessCard = ({
  ...
  return (
    <article className="group flex h-full flex-col rounded-[20px] border border-(--border) bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-(--primary) hover:shadow-lg">
