...
type TravelRequirementsHeroProps = {
  content: TravelRequirementsHeroContent;
};

export const TravelRequirementsHero = ({
  content,
}: TravelRequirementsHeroProps) => {
